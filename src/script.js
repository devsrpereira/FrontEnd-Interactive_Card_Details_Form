...
function confirm(){
let holder_name = document.getElementById('iholder_name')
let card_num = document.getElementById('#icard_number')
let mm_exp = document.getElementById('imm_exp')
let yy_exp = document.getElementById('iyy_exp')
let cvc = document.getElementById('icvc')

card_num = Number(value.card_num)

if (length.card_num !== 16){
